...
const ShimmerMenu = () => {
  return (
    <div className="display flex flex-col xs:mx-3 ss:mx-10 sm:mx-16 md:mx-28 lg:mx-32 xl:mx-60 animate-pulse">
      ...
      {Array(16)
        ...
        .map((e, indx) => (
          ...
          >
            ...
            <p className=" xs:px-2 xs:py-0 sm:px-5 lg:px-8 sm:py-1 xs:w-24 xs:h-16 md:w-36 md:h-24 border bg-lightgray"></p>
          </div>
        ))}
    </div>
  );
